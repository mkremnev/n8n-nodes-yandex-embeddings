	...
	properties: INodeProperties[] = [
		{
			...
			description:
				'Folder ID for accessing the Yandex GPT API. You can find it in the <a href="https://yandex.cloud/ru/docs/resource-manager/operations/folder/get-id" target="_blank">Yandex Cloud Console</a>.',
			required: true,
		},
		{
			displayName: 'API Key',
